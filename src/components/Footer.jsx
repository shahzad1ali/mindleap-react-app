...
import footerLogo from "../assets/footer-logo (1).svg"
import { FaEnvelope, FaFacebook, FaInstagram, FaMapMarkedAlt, FaPhoneAlt, FaTwitter, FaYoutube } from 'react-icons/fa'
    ...
    <div className='py-12 bg-gray-100 px-8'>
       ...
       <div className='space-y-6 mr-14'>
        <div className='flex items-center space-x-2'>  
         <img src={footerLogo} alt="" className='w-full h-auto' />
        </div>
        <p className='text-para'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Fuga, hic nam totam doloribus, sunt sed accusamus id similique consequatur odio.</p>
...
<li>
            ...
            <a href="#services"  className='hover:underline text-gray-700'>Services</a>
             ...
             <li>
             <a href="#contant"  className='hover:underline text-gray-700'>Contact Us</a>
             </li>
...
<li>
            ...
            <a href="#"  className='hover:underline text-gray-700'>Privacy Policy</a>
             ...
             <li>
             <a href="#contant"  className='hover:underline text-gray-700'>Support Center</a>
             </li>
       ...
       <div className='space-x-6'>
        ...
        <ul className='space-y-3'>
            <li className='flex items-center gap-2'>
                ...
                <p className='text-gray-700'>12, street, city, country</p>
             </li> 
             <li className='flex items-center gap-2'>
                <FaPhoneAlt className='text-primary'/>
                <p className='text-gray-700'>+90,85792,78</p>
             </li> 
             <li className='flex items-center gap-2'>
                <FaEnvelope className='text-primary'/>
                <p className='text-gray-700'>Info@Msg</p>
             </li> 
