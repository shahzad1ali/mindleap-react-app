    ...
    <div id='pricing' className='bg-[#f7f8fc] pt-32'>
      <div className='container mx-auto px-8'> 
        <div className='text-center mb-12'>
          ...
          <p className='text-lg mb-12 md:w-2/3 mx-auto'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Ea quasi odio exercitationem facere aliquid magni. Minus nemo in quasi autem. Facere maxime quasi exercitationem unde, alias molestiae pariatur labore!.</p>
        </div>
