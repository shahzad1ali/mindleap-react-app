    ...
    <div className='relative bg-cover bg-center py-12 bg-working-img'>
        ...
        className='relative container mx-auto px-4 py-25'>
            <div className='text-white text-center mb-20'>
                ...
                <p className='text-lg md:w1/2 w-full mx-auto'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Veritatis, rem! Debitis assumenda fuga nisi autem non sunt adipisci veritatis ratione!</p>
            </div>
              ...
              <div className='relative bg-white text-center rounded-lg p-6 flex-1'>
                ...
                <p className='my-2'>Step 1 description goes here. lorem ipsem dolor sit amit, consectetur adipisicing elit.</p>
              </div>
              ...
              <div className='relative bg-white text-center rounded-lg p-6 flex-1'>
                ...
                <p className='my-2'>Step 2 description goes here. lorem ipsem dolor sit amit, consectetur adipisicing elit.</p>
              </div>
              ...
              <div className='relative bg-white text-center rounded-lg p-6 flex-1'>
                ...
                <p className='my-2'>Step 3 description goes here. lorem ipsem dolor sit amit, consectetur adipisicing elit.</p>
              </div>
              </div>
